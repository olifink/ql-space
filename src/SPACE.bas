...
31775      IF sw%=-1
31780         SELect ON it
31785           =PEEK(area+88):CURDIS#ach:CLOSE #ach:CH_WIN PEEK_L(area+80)
31787                          OPEN #ach,'con_2x1a0x0':DR_CHAN #ach;area
31790           =PEEK(area+89):CURDIS #ach:CLOSE #ach:CH_WIN PEEK_L(area+80),dx,dy
31795                          POKE_W area+260,dx:POKE_W area+262,dy
31797                          OPEN #ach,'con_2x1a0x0':DR_CHAN #ach;area
31800                          why=4
31805           =PEEK(area+91):IF PEEK(area+86)&&1=1 THEN CLOSE #ach:rd_button #ch;area:why=2:OPEN #ach,'con_2x1a0x0':DR_CHAN #ach;area:ELSE :why=1
...
32600 END DEFine 
32610 REMark ---------------------------------------------------------------------
32720 REMark          Application Manager v1.01 written by O.Fink
32730 REMark ---------------------------------------------------------------------
